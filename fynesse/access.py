...
def create_database_ifne(conn):
    ...
    :param conn: database connection"""
    return execute(conn,"CREATE DATABASE IF NOT EXISTS `property_prices` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin", output_queries=True)
...
def inner_join(conn, bbox = None, invert_bbox=False, date_bound = None, limit=None, one_in = None, output_query=False):
    """
...
"very_negative_amenities":
  {"amenity":["brothel","casino","gambling","love_hotel","swingerclub","prison","stripclub"]},
